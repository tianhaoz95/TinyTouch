...
def generate_project(ios_sources, ios_resources, watch_sources, watch_resources, widget_sources=None, widget_resources=None):
    ...
    pbx.append("\t\t\t\tMARKETING_VERSION = 1.1;")
    pbx.append("\t\t\t\tCURRENT_PROJECT_VERSION = 3;")
    pbx.append("\t\t\t\tINFOPLIST_KEY_CFBundleShortVersionString = 1.1;")
    pbx.append("\t\t\t\tINFOPLIST_KEY_CFBundleVersion = 3;")
