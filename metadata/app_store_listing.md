# TinyTouch: App Store Listing Metadata

## App Information

* **App Name** (max 30 characters):  
  `TinyTouch: Toddler Lock & Play` (29 characters)
...
> Keep little hands happily engaged on your wrist while preventing accidental phone calls, notification swipes, and app exits. 5 gentle sensory games with lullaby wind-down.
...
`toddler,baby,lock,toddler lock,baby games,sensory,chimes,bubbles,guided access,watch games,kids` (94 characters)
...
## Age Rating & Privacy Questionnaire Answers for App Store Connect
* **Age Rating**: `4+` (Made for Kids: Ages 5 and Under)
